...
<body class="min-h-screen flex items-center justify-center p-6" style="background:#0b1324;">
    ...
    <div class="w-full max-w-md space-y-4">
        ...
        <div class="text-center">
            ...
            <h2 class="text-xl font-extrabold text-white">Pesanan Berhasil!</h2>
        ...
        <div class="rounded-2xl p-5 text-center"
            ...
            <p class="text-5xl font-extrabold text-white tracking-widest">
        ...
        <div class="rounded-2xl p-5 space-y-3 text-sm"
            ...
            <div class="grid grid-cols-2 gap-y-2">
                ...
                <span class="font-semibold text-white text-right">{{ $order->student_name }}</span>

                <span style="color:#94a3b8;">Kelas</span>
                <span class="font-semibold text-white text-right">{{ $order->class_major }}</span>
            ...
            {{-- Total --}}
            <div class="flex justify-between items-center font-extrabold text-base pt-2 border-t"
        ...
        {{-- CTA --}}
        <a href="{{ route('home') }}"
           class="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl font-bold text-sm text-white transition shadow-lg"
